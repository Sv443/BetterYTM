...
function addCfgMenu() {
    ...
    return menu_old_awaiter(this, void 0, void 0, function* () {
        ...
        addLink(yield getResourceUrl("greasyfork"), "https://greasyfork.org/en/scripts/475682-betterytm", t("open_greasyfork", constants_scriptInfo.name));
        addLink(yield getResourceUrl("openuserjs"), "https://openuserjs.org/scripts/Sv443/BetterYTM", t("open_openuserjs", constants_scriptInfo.name));
