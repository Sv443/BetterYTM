...
// @icon              http://localhost:8710/assets/logo/logo_48.png?t=b8a93a76-8343-4cd0-b971-16da33524efa
...
// @grant             unsafeWindow
// @noframes
// @resource          close       http://localhost:8710/assets/icons/close.png?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          logo        http://localhost:8710/assets/logo/logo_48.png?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          arrow_down  http://localhost:8710/assets/icons/arrow_down.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          delete      http://localhost:8710/assets/icons/delete.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          error       http://localhost:8710/assets/icons/error.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          globe       http://localhost:8710/assets/icons/globe.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          help        http://localhost:8710/assets/icons/help.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          lyrics      http://localhost:8710/assets/icons/lyrics.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          skip_to     http://localhost:8710/assets/icons/skip_to.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          spinner     http://localhost:8710/assets/icons/spinner.svg?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          discord     http://localhost:8710/assets/external/discord.png?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          github      http://localhost:8710/assets/external/github.png?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          greasyfork  http://localhost:8710/assets/external/greasyfork.png?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          openuserjs  http://localhost:8710/assets/external/openuserjs.png?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          fix_spacing http://localhost:8710/assets/other/fixSpacing.css?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-de_DE    http://localhost:8710/assets/translations/de_DE.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-en_US    http://localhost:8710/assets/translations/en_US.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-en_UK    http://localhost:8710/assets/translations/en_UK.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-es_ES    http://localhost:8710/assets/translations/es_ES.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-fr_FR    http://localhost:8710/assets/translations/fr_FR.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-hi_IN    http://localhost:8710/assets/translations/hi_IN.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-ja_JA    http://localhost:8710/assets/translations/ja_JA.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-pt_BR    http://localhost:8710/assets/translations/pt_BR.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
// @resource          tr-zh_CN    http://localhost:8710/assets/translations/zh_CN.json?t=b8a93a76-8343-4cd0-b971-16da33524efa
...
tr.getLanguage = () => {
  return curLang;
};var UserUtils=/*#__PURE__*/Object.freeze({__proto__:null,ConfigManager:ConfigManager,SelectorObserver:SelectorObserver,addGlobalStyle:addGlobalStyle,addParent:addParent,autoPlural:autoPlural,clamp:clamp,compress:compress,debounce:debounce,decompress:decompress,fetchAdvanced:fetchAdvanced,getUnsafeWindow:getUnsafeWindow$1,insertAfter:insertAfter,insertValues:insertValues,interceptEvent:interceptEvent,interceptWindowEvent:interceptWindowEvent,isScrollable:isScrollable,mapRange:mapRange,openInNewTab:openInNewTab,pauseFor:pauseFor,preloadImages:preloadImages,randRange:randRange,randomId:randomId,randomItem:randomItem,randomItemIndex:randomItemIndex,randomizeArray:randomizeArray,takeRandomItem:takeRandomItem,tr:tr});const selectorMap = new Map();
/**
...
const scriptInfo = {
    ...
    buildNumber: "438e880", // asserted as generic string instead of literal
};var de_DE = {
...
preInit();})();//# sourceMappingURL=http://localhost:8710/BetterYTM.user.js.map
