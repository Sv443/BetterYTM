...
// @icon              http://localhost:8710/assets/logo/logo_48.png?t=1696345562361
...
// @grant             unsafeWindow
// @noframes
// @resource          logo             http://localhost:8710/assets/logo/logo_48.png?t=1696345562361
// @resource          close            http://localhost:8710/assets/icons/close.png?t=1696345562361
// @resource          delete           http://localhost:8710/assets/icons/delete.svg?t=1696345562361
// @resource          error            http://localhost:8710/assets/icons/error.svg?t=1696345562361
// @resource          lyrics           http://localhost:8710/assets/icons/lyrics.svg?t=1696345562361
// @resource          spinner          http://localhost:8710/assets/icons/spinner.svg?t=1696345562361
// @resource          arrow_down       http://localhost:8710/assets/icons/arrow_down.svg?t=1696345562361
// @resource          skip_to          http://localhost:8710/assets/icons/skip_to.svg?t=1696345562361
// @resource          volume_boost_off http://localhost:8710/assets/icons/volume_boost_off.svg?t=1696345562361
// @resource          volume_boost_on  http://localhost:8710/assets/icons/volume_boost_on.svg?t=1696345562361
// @resource          github           http://localhost:8710/assets/external/github.png?t=1696345562361
// @resource          greasyfork       http://localhost:8710/assets/external/greasyfork.png?t=1696345562361
// @resource          openuserjs       http://localhost:8710/assets/external/openuserjs.png?t=1696345562361
// @resource          tr-de_DE         http://localhost:8710/assets/translations/de_DE.json?t=1696345562361
// @resource          tr-en_US         http://localhost:8710/assets/translations/en_US.json?t=1696345562361
// @resource          tr-en_UK         http://localhost:8710/assets/translations/en_UK.json?t=1696345562361
// @resource          tr-es_ES         http://localhost:8710/assets/translations/es_ES.json?t=1696345562361
// @resource          tr-fr_FR         http://localhost:8710/assets/translations/fr_FR.json?t=1696345562361
// @resource          tr-hi_IN         http://localhost:8710/assets/translations/hi_IN.json?t=1696345562361
// @resource          tr-ja_JA         http://localhost:8710/assets/translations/ja_JA.json?t=1696345562361
// @resource          tr-pt_BR         http://localhost:8710/assets/translations/pt_BR.json?t=1696345562361
// @resource          tr-zh_CN         http://localhost:8710/assets/translations/zh_CN.json?t=1696345562361
...
const scriptInfo = {
    ...
    buildNumber: "00f1863", // asserted as generic string instead of literal
};
...
function initRememberSongTime() {
    return __awaiter(this, void 0, void 0, function* () {
            ...
            if (songTimestamp > 0 && songTime > 0 && Date.now() - songTimestamp < rememberSongTimeout) {
                (0,_sv443_network_userutils__WEBPACK_IMPORTED_MODULE_0__.onSelector)(_utils__WEBPACK_IMPORTED_MODULE_1__.ytmVideoSelector, {
                    listener: (vidElem) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const applyTime = () => vidElem.currentTime = (0,_sv443_network_userutils__WEBPACK_IMPORTED_MODULE_0__.clamp)(Math.max(songTime - 1, 0), 0, vidElem.duration);
        ...
        GM.getValue("bytm-rem-song-timestamp").then((ts) => __awaiter(this, void 0, void 0, function* () {
...
/* harmony import */ var _features_index__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./features/index */ "./src/features/index.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...

{
    ...
    console.log([
        "Powered by:",
        "─ lots of ambition",
        `─ my song metadata API: ${_features_index__WEBPACK_IMPORTED_MODULE_8__.geniUrlBase}`,
...
function preInit() {
    ...
    if (domain === "ytm")
        (0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initBeforeUnloadHook)();
    init();
}
function init() {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            (0,_features_index__WEBPACK_IMPORTED_MODULE_8__.preInitLayout)(features);
            (0,_features_index__WEBPACK_IMPORTED_MODULE_8__.preInitBehavior)(features);
            (0,_features_index__WEBPACK_IMPORTED_MODULE_8__.preInitInput)(features);
            if (features.disableBeforeUnloadPopup && domain === "ytm")
                (0,_features_index__WEBPACK_IMPORTED_MODULE_8__.disableBeforeUnload)();
            if (!domLoaded)
                document.addEventListener("DOMContentLoaded", initFeatures);
            else
                initFeatures();
            if (features.rememberSongTime)
                (0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initRememberSongTime)();
        }
        catch (err) {
...
/*# sourceMappingURL=http://localhost:8710/global.css.map*/`);
        ...
        try {
            if (domain === "ytm") {
                ...
                (0,_sv443_network_userutils__WEBPACK_IMPORTED_MODULE_0__.onSelector)("tp-yt-iron-dropdown #contentWrapper ytd-multi-page-menu-renderer #container.menu-container", { listener: _features_index__WEBPACK_IMPORTED_MODULE_8__.addConfigMenuOption });
                if (features.arrowKeySupport)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initArrowKeySkip)());
                if (features.removeUpgradeTab)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.removeUpgradeTab)());
                if (features.watermarkEnabled)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.addWatermark)());
                if (features.geniusLyrics)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.addMediaCtrlLyricsBtn)());
                if (features.deleteFromQueueButton || features.lyricsQueueButton)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initQueueButtons)());
                if (features.anchorImprovements)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.addAnchorImprovements)());
                if (features.closeToastsTimeout > 0)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initAutoCloseToasts)());
                if (features.removeShareTrackingParam)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.removeShareTrackingParam)());
                if (features.numKeysSkipToTime)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initNumKeysSkip)());
                if (features.fixSpacing)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.fixSpacing)());
                if (features.scrollToActiveSongBtn)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.addScrollToActiveBtn)());
                if (features.boostGain)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.addBoostGainButton)());
                ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initVolumeFeatures)());
            }
            if (["ytm", "yt"].includes(domain)) {
                if (features.switchBetweenSites)
                    ftInit.push((0,_features_index__WEBPACK_IMPORTED_MODULE_8__.initSiteSwitch)(domain));
            }
