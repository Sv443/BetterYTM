...
// @noframes
// @updateURL         https://raw.githubusercontent.com/Sv443/BetterYTM/refs/heads/main/dist/BetterYTM_oujs.user.js
// @downloadURL       https://openuserjs.org/src/scripts/Sv443/BetterYTM.user.js
// @grant             GM.getValue
// @grant             GM.setValue
...
function isAlertActive(alert, alertsData) {
    ...
    if ("version" in alert && alert.version !== scriptInfo$1.version)
        return false;
    if ("versionMin" in alert && alert.versionMin && compareVersions.compareVersions(alert.versionMin, scriptInfo$1.version) > 0)
        return false;
    if ("versionMax" in alert && alert.versionMax && compareVersions.compareVersions(alert.versionMax, scriptInfo$1.version) < 0)
        return false;
