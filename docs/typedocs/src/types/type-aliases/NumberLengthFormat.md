...
[@sv443/betterytm](../../../modules.md) / [src/types](../README.md) / NumberLengthFormat

# Type Alias: NumberLengthFormat

> **NumberLengthFormat** = `"short"` \| `"long"`

Defined in: [src/types.ts:175](https://github.com/Sv443/BetterYTM/blob/3cbe26faf20a275f47c79e6afeb522f79d4b924d/src/types.ts#L175)
