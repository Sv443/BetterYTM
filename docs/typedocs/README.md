...
## Installation
Note: by installing BetterYTM, you agree to the [license terms](_media/LICENSE.txt), [disclaimers](#disclaimers) and [privacy notice.](#privacy)
...
To find out more about these integrations, [click here](_media/integrations.md)
...
Refer to the [plugin creation guide](_media/contributing.md#developing-a-plugin-that-interfaces-with-betterytm) for more information or check out the [official plugin template](https://github.com/Sv443/BetterYTM-Plugin-Template) for a quick start on creating a plugin.
...
**For information on how to set this project up locally, contribute to it, or create plugins for BetterYTM, see [the contributing guide](_media/contributing.md)**  
...
For development dependencies, please refer to `devDependencies` in [`package.json`](_media/package.json)
  
#### Icon attributions
- Most icons are from [Material Icons](https://fonts.google.com/icons)
- For external icon attributions, see [`assets/images/external/README.md`](_media/README.md)
